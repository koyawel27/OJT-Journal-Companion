...
- Offline-first browser use after initial load
...
### Mobile
- Bottom tab navigation: Home, Weeks, Logs, Preview, Backup
...
**Navigation:** Desktop uses sidebar; mobile uses bottom tabs + profile header button.
...
**Requirements:** Modern browser with IndexedDB support. No internet needed after first load.
...
### Mobile (≤760px width)
- [ ] Bottom tabs switch sections
- [ ] Daily log editor usable on small screen

### Offline
- [ ] Core flows work with network disabled after initial load
